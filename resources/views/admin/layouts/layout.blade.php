...
<div class="flex min-h-screen">
    ...
    >
        ...
        <nav class="flex-1 p-4 space-y-1">
            ...
            @can('view admins')
            <p class="text-gray-800 dark:text-gray-600 text-xs uppercase tracking-wider px-3 py-2 mt-4 font-semibold">Administration</p>
            <a href="{{ route('admin.admins.index') }}" class="sidebar-link {{ request()->routeIs('admin.admins.*') && !request()->routeIs('admin.admins.roles') ? 'active' : '' }}">
            ...
            @can('manage roles')
            <a href="{{ route('admin.admins.roles') }}" class="sidebar-link {{ request()->routeIs('admin.admins.roles') ? 'active' : '' }}">
